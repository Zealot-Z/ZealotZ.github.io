...
$(function() {
    ...
    $('body').on('click', function(e) {
        ...
        switch (true) {
            ...
            //         $('#qr').qrcode({ width: 128, height: 128, text: location.url}).toggle()
            //     }
            //     return false;
            //     break;
            // wechat
            case (tag.indexOf('icon-wechat') != -1):
                if ($('.icon-wechat').hasClass('tg')) {
                    ...
                    $('#qr').qrcode({ width: 128, height: 128, text: "https://u.wechat.com/ED20FPK6nxaoe4ip5jevYIg"}).toggle()
                }
                return false;
                break;
            // // linkedin
            // case (tag.indexOf('icon-linkedin') != -1):
            //     if ($('.icon-linkedin').hasClass('tg')) {
            //         $('#qr1').toggle()
            //     } else {
            //         $('.icon-linkedin').addClass('tg')
            //         $('#qr1').qrcode({ width: 128, height: 128, text: "https://www.linkedin.com/in/haotian-zhou/"}).toggle()
            //     }
            //     return false;
            //     break;
            // audio play
